...
/**
 * Created by Senthil on 08/06/16.
 */
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                // Get the layout
                RemoteViews views = new RemoteViews(getPackageName(), R.layout.stock_widget_item);
                ...
                views.setTextViewText(R.id.bid_price, data.getString(data.getColumnIndex(getResources().getString(R.string.string_bid_price))));
